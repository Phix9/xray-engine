...
namespace XrayEngine
{
    ...
    public:
        ...
        void UpdateDescriptorSets(std::vector<vk::WriteDescriptorSet> &writes, std::vector<vk::CopyDescriptorSet> &copies);
        ...
        void CommandBindDescriptorSet(const vk::CommandBuffer &commandBUffer, vk::PipelineBindPoint bindPoint, vk::PipelineLayout layout, uint32_t firstSet, std::vector<vk::DescriptorSet> descriptorSets, std::vector<uint32_t> dynamicOffsets);
        void CommandBindVertexBuffer(const vk::CommandBuffer &commandBuffer, uint32_t firstBinding, std::vector<vk::Buffer> vertexBuffers, std::vector<vk::DeviceSize> offsets);
